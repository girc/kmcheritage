 ...
 * @property string  $sign_up_host
 * @property string  $sign_up_agent
 */
...
//------------------------------------------------------------------------------------------------//
     ...
     */
    public function setSignUpRequestDetails($request){
        $this->sign_up_ip = $request->getUserIP();
        $this->sign_up_agent = $request->getUserAgent();
        $this->sign_up_host = $request->getUserHost();
    }
}
