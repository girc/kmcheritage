...
namespace common\components\PhotoManager\widgets;
 ...
 */
class PhotoManagerWidget extends Widget
{
    /** @var ActiveRecord */
    public $model;
    ...
    public function registerTranslations()
    {
        ...
        $i18n->translations['galleryManager/*'] = [
            ...
            'basePath' => '@common/components/PhotoManager/messages',
            'fileMap' => [],
        ];
    }
    ...
    public function run()
    {
        ...
        $view = $this->getView();
        PhotoManagerAsset::register($view);
